    ...
    <body>
        ...
        <div>
            <table border="1" style="width:100%;background-color:#e0ebeb; margin:0 auto;">
                <tr bgcolor="#000000">
                    <th colspan="4"><center><asp:Label ID="lblRoomDetail" runat="server" Text="Room Detail" Font-Size="Large" ForeColor="White"></asp:Label></center></th>
                </tr>
                <tr>
                    <td rowspan="16" style="width:50%"><asp:Image ID="imgRoom" runat="server" width="100%" height="60%"/></td>
                    <td style="width:26%"><center><b><asp:Label ID="lblRoomType" runat="server" Text="Room Type" Width="150px"></asp:Label></b></center></td>
                    <td style="width:24%">
                        <center>
        ...
        <div>
            <table border="1" style="width:400px;background-color:#e0ebeb; margin:0 auto">
                    ...
                    <tr>
                        <td style="width:50%"><center><b><asp:Label ID="lblCheckInDate" runat="server" Text="Check-in Date" Width="150px"></asp:Label></b></center></td>
