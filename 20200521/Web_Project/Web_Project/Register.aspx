    ...
    <body>
        ...
        <table border="1" style="width:150px;background-color:#e0ebeb; margin:0 auto;">
            ...
            <tr>
                ...
                <td><center><asp:TextBox ID="txtFirstName" runat="server" Width="150px" autocomplete="off" MaxLength="50"></asp:TextBox></center></td>
            </tr>
            <tr>
                <td><center><b><asp:Label ID="lblLastName" runat="server" Text="Last Name" Width="150px"></asp:Label></b></center></td>
                <td><center><asp:TextBox ID="txtLastName" runat="server" Width="150px" autocomplete="off" MaxLength="50"></asp:TextBox></center></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><center><asp:TextBox ID="txtPhone" runat="server" Width="150px" autocomplete="off" MaxLength="50"></asp:TextBox></center></td>
            </tr>
            <tr>
                <td><center><b><asp:Label ID="lblPassport" runat="server" Text="Passport No" Width="150px"></asp:Label></b></center></td>
                <td><center><asp:TextBox ID="txtPassport" runat="server" Width="150px" autocomplete="off" MaxLength="50"></asp:TextBox></center></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><center><asp:TextBox ID="txtConfirmPassword" runat="server" TextMode="Password" Width="150px" autocomplete="off" MaxLength="50"></asp:TextBox></center></td>
            </tr>
            <tr bgcolor="#000000">
            ...
            <tr>
                <td colspan="2"><asp:TextBox ID="txtQuestionOne" runat="server" autocomplete="off" Width="100%" MaxLength="50"></asp:TextBox></td>
            </tr>
            <tr>
                <td colspan="2"><b><asp:Label ID="lblQuestionTwo" runat="server" Text="Q2. What’s your favorite country ?"></asp:Label></b></td>
            </tr>
            <tr>
                <td colspan="2"><asp:TextBox ID="txtQuestionTwo" runat="server" autocomplete="off" Width="100%" MaxLength="50"></asp:TextBox></td>
            </tr>
            <tr>
                <td colspan="2"><b><asp:Label ID="lblQuestionThree" runat="server" Text="Q3. Where are you born?"></asp:Label></b></td>
            </tr>
            <tr>
                <td colspan="2"><asp:TextBox ID="txtQuestionThree" runat="server" autocomplete="off" Width="100%" MaxLength="50"></asp:TextBox></td>
            </tr>
            <tr bgcolor="#000000">
