...
namespace Web_Project
{
    public partial class Client_Booking : System.Web.UI.Page
    {
        ...
        protected void btnBooking_Click(object sender, EventArgs e)
        {
            ...
            {
                if (dt.Rows[0].Field<int>("total_standard") - dt.Rows[0].Field<int>("booked_standard") <= 0)
                {
            ...
            else if (ddlRoomType.SelectedValue == "2")
            {
                if (dt.Rows[0].Field<int>("total_deluxe") - dt.Rows[0].Field<int>("booked_deluxe") <= 0)
                {
            ...
            else if (ddlRoomType.SelectedValue == "3")
            {
                if (dt.Rows[0].Field<int>("total_studio") - dt.Rows[0].Field<int>("booked_studio") <= 0)
                {
            ...
            if (sp_booking(Session["email"].ToString(), ddlRoomType.SelectedValue, ddlBedType.SelectedValue, txtCheckInDate.Text, txtCheckOutDate.Text, txtTotalPrice.Text, txtRemark.Text, txtCreditCard.Text) >= 1)
            {
