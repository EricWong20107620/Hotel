<%@ Page Title="Client Booking History" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Client_Booking_History.aspx.cs" Inherits="Web_Project.Client_Booking_History" %>
                    ...
                    <td style="width:50%">
                        ...
                        <asp:Panel ID="pMaster" runat="server" Height="300px" ScrollBars="Vertical" Width="95%" BackColor="White">
                            ...
                            <asp:DataList ID="BookingList" runat="server" Width="100%" OnItemCommand="BookingList_ItemCommand">
                                ...
                                <table style="width:100%">
                                    <tr>
                                        <td style="width:25%"><center><asp:Label ID="lblTotalRoom2" runat="server" Text='<%# Eval("booking_id") %>'></asp:Label></center></td>
